...
export default function SubscribersSection() {
  ...
  return (
    <>
      ...
      {loading && !channels ? (
        ...
        >
          ...
          >
            ...
            <span className="font-bold th-color-for">add subscriber</span>
          </li>
      ...
      <SelectChannelModal 
        filter={(ch: any) => (
          !channel?.announcementSubscribers.includes(ch.objectId)
        )}
        onClick={
          async (channel: any) => {
            try {
              await postData(`/channels/${channel.objectId}/subscribe/${channelId}`);
